...
const testTemplateText = [
	...
	`The brave knight [Name:1] rode their [adjective:1] [landAnimal:1] to the [place:1]. At the [place:1], [name:1] found a [adjective:2] [noun:1]. "I must bring this [noun:1] back to [place:2]," said [name:1]. But suddenly, the [land animal:1] started to [verb:1]! "Stop [verb:1]ing!" shouted [name:1]. "We need to get this [adjective:2] [noun:1] to [place:2] before the [adjective:1] [noun:2] arrives!"`,
];
